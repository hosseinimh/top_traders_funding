...
class StoreChallengeLeverageRequest extends FormRequest
{
    ...
    {
        return [
            'value' => 'required|numeric|min:50|max:1000|unique:tbl_challenge_leverages',
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'value.unique' => __('challenge_leverage.value_unique'),
        ];
    }
}
