...
class UserResource extends JsonResource
{
    public function toArray($request)
    {
        return [
            ...
            'verifyRequest1AtLocale' => app()->getLocale() !== Locale::FA ?  $this->verify_request_1_at : Helper::faDate2($this->verify_request_1_at),
            ...
            'emailVerifiedAtLocale' => app()->getLocale() !== Locale::FA ?  $this->email_verified_at : Helper::faDate2($this->email_verified_at),
            'selfieFile' => $this->selfie_file,
            'identityFile' => $this->identity_file,
            'verifyRequest3At' => $this->verify_request_3_at,
            'verifyRequest3AtLocale' => app()->getLocale() !== Locale::FA ?  $this->verify_request_3_at : Helper::faDate2($this->verify_request_3_at),
            'verifiedAt' => $this->verified_at,
            'verifiedAtLocale' => app()->getLocale() === Locale::FA ? Helper::faDate2($this->verified_at) : $this->verified_at,
